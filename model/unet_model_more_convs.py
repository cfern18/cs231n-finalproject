...
# Base Unet Model extention. Adds more Conv layers before output.
...
class UNet(nn.Module):
    ...
    def __init__(self, params):
        ...
        self.outc = outconv(32, params.out_channels) #outconv includes sigmoid activation to squeeze input btw 0 and 1
